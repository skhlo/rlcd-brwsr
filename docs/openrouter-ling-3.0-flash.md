...
Retrieved **2026-09-22 UTC**. This is public-source and offline payload evidence,
not live-provider acceptance: no authenticated provider request or live inference
was made. The user selected this model for the planned native helper; current
production code has not been rewritten.
